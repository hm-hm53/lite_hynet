...
def parse_args():
    ...
    parser.add_argument("--mask-dir", default="/root/autodl-tmp/data/LoveDA/Test/masks_png")
    parser.add_argument("--output-mask-dir", default="/root/autodl-tmp/data/LoveDA/Test/masks_png_convert")
