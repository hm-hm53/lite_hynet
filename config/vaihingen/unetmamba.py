...
from UNetMamba1 import UNetMamba
...
train_dataset = VaihingenDataset(data_root='/root/autodl-tmp/data/vaihingen/train_'+str(image_size), mode='train',
                                 mosaic_ratio=0.25, transform=train_aug)

val_dataset = VaihingenDataset(data_root='/root/autodl-tmp/data/vaihingen/val_'+str(image_size),
                               transform=val_aug)

test_dataset = VaihingenDataset(data_root='/root/autodl-tmp/data/vaihingen/test_'+str(image_size),
                                transform=val_aug)
